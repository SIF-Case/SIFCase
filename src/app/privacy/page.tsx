      ...
      <section className="pb-16 pt-6">
        <div className="max-w-[1000px] mx-auto px-6 lg:px-8">
          <div className="space-y-8">
            ...
            <div className="bg-white rounded-[16px] border border-rule shadow-card p-6">
              <div className="flex items-start gap-3 mb-3">
                <span className="text-[12px] font-mono text-[#098B91] mt-1 w-5 flex-shrink-0">01</span>
                <h2 className="text-[16px] font-semibold text-[#098B91] text-balance">Introduction</h2>
              </div>
            ...
            <div className="bg-white rounded-[16px] border border-rule shadow-card p-6">
              <div className="flex items-start gap-3 mb-3">
                <span className="text-[12px] font-mono text-[#098B91] mt-1 w-5 flex-shrink-0">02</span>
                <h2 className="text-[16px] font-semibold text-[#098B91] text-balance">Information We Collect</h2>
              </div>
              <div className="text-[14px] text-body leading-[1.7] text-pretty pl-8 space-y-4">
                <div>
                  <h3 className="font-medium text-heading mb-2 text-balance">2.1 Information you provide directly</h3>
                ...
                <div>
                  <h3 className="font-medium text-heading mb-2 text-balance">2.2 Information collected automatically</h3>
                  <ul className="list-disc pl-5 space-y-1.5">
                ...
                <div>
                  <h3 className="font-medium text-heading mb-2 text-balance">2.3 Information from third parties</h3>
                  <ul className="list-disc pl-5 space-y-1.5">
            ...
            <div className="bg-white rounded-[16px] border border-rule shadow-card p-6">
              <div className="flex items-start gap-3 mb-3">
                <span className="text-[12px] font-mono text-[#098B91] mt-1 w-5 flex-shrink-0">03</span>
                <h2 className="text-[16px] font-semibold text-[#098B91] text-balance">How We Use Your Information</h2>
              </div>
              <div className="text-[14px] text-body leading-[1.7] text-pretty pl-8 space-y-3">
            ...
            <div className="bg-white rounded-[16px] border border-rule shadow-card p-6">
              <div className="flex items-start gap-3 mb-3">
                <span className="text-[12px] font-mono text-[#098B91] mt-1 w-5 flex-shrink-0">04</span>
                <h2 className="text-[16px] font-semibold text-[#098B91] text-balance">Cookies and Analytics</h2>
              </div>
              <div className="text-[14px] text-body leading-[1.7] text-pretty pl-8 space-y-3">
            ...
            <div className="bg-white rounded-[16px] border border-rule shadow-card p-6">
              <div className="flex items-start gap-3 mb-3">
                <span className="text-[12px] font-mono text-[#098B91] mt-1 w-5 flex-shrink-0">05</span>
                <h2 className="text-[16px] font-semibold text-[#098B91] text-balance">Legal Basis and Consent</h2>
              </div>
              <div className="text-[14px] text-body leading-[1.7] text-pretty pl-8 space-y-3">
            ...
            <div className="bg-white rounded-[16px] border border-rule shadow-card p-6">
              <div className="flex items-start gap-3 mb-3">
                <span className="text-[12px] font-mono text-[#098B91] mt-1 w-5 flex-shrink-0">06</span>
                <h2 className="text-[16px] font-semibold text-[#098B91] text-balance">How We Share Your Information</h2>
              </div>
              <div className="text-[14px] text-body leading-[1.7] text-pretty pl-8 space-y-3">
            ...
            <div className="bg-white rounded-[16px] border border-rule shadow-card p-6">
              <div className="flex items-start gap-3 mb-3">
                <span className="text-[12px] font-mono text-[#098B91] mt-1 w-5 flex-shrink-0">07</span>
                <h2 className="text-[16px] font-semibold text-[#098B91] text-balance">Data Retention</h2>
              </div>
              <div className="text-[14px] text-body leading-[1.7] text-pretty pl-8 space-y-3">
            ...
            <div className="bg-white rounded-[16px] border border-rule shadow-card p-6">
              <div className="flex items-start gap-3 mb-3">
                <span className="text-[12px] font-mono text-[#098B91] mt-1 w-5 flex-shrink-0">08</span>
                <h2 className="text-[16px] font-semibold text-[#098B91] text-balance">Data Security</h2>
              </div>
              <div className="text-[14px] text-body leading-[1.7] text-pretty pl-8 space-y-3">
            ...
            <div className="bg-white rounded-[16px] border border-rule shadow-card p-6">
              <div className="flex items-start gap-3 mb-3">
                <span className="text-[12px] font-mono text-[#098B91] mt-1 w-5 flex-shrink-0">09</span>
                <h2 className="text-[16px] font-semibold text-[#098B91] text-balance">Your Rights</h2>
              </div>
              <div className="text-[14px] text-body leading-[1.7] text-pretty pl-8 space-y-3">
            ...
            <div className="bg-white rounded-[16px] border border-rule shadow-card p-6">
              <div className="flex items-start gap-3 mb-3">
                <span className="text-[12px] font-mono text-[#098B91] mt-1 w-5 flex-shrink-0">10</span>
                <h2 className="text-[16px] font-semibold text-[#098B91] text-balance">Grievance Officer and Contact</h2>
              </div>
              <div className="text-[14px] text-body leading-[1.7] text-pretty pl-8 space-y-3">
            ...
            <div className="bg-white rounded-[16px] border border-rule shadow-card p-6">
              <div className="flex items-start gap-3 mb-3">
                <span className="text-[12px] font-mono text-[#098B91] mt-1 w-5 flex-shrink-0">11</span>
                <h2 className="text-[16px] font-semibold text-[#098B91] text-balance">Children's Privacy</h2>
              </div>
              <div className="text-[14px] text-body leading-[1.7] text-pretty pl-8 space-y-3">
            ...
            <div className="bg-white rounded-[16px] border border-rule shadow-card p-6">
              <div className="flex items-start gap-3 mb-3">
                <span className="text-[12px] font-mono text-[#098B91] mt-1 w-5 flex-shrink-0">12</span>
                <h2 className="text-[16px] font-semibold text-[#098B91] text-balance">Changes to This Policy</h2>
              </div>
              <div className="text-[14px] text-body leading-[1.7] text-pretty pl-8 space-y-3">
          ...
          <div className="mt-10 rounded-[16px] border border-rule bg-white p-6 flex items-start gap-4">
            ...
            <div>
              <p className="text-[14px] font-semibold text-heading mb-1">Questions about privacy?</p>
